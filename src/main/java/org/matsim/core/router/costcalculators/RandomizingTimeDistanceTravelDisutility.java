...
final class RandomizingTimeDistanceTravelDisutility implements TravelDisutility {
	...
	final private static Logger log = Logger.getLogger(RandomizingTimeDistanceTravelDisutility.class);
	...
	public double getLinkTravelDisutility(final Link link, final double time, final Person person, final Vehicle vehicle) {
		...
		if ( sigma != 0. ) {
			if ( person==null ) {
				throw new RuntimeException("you cannot use the randomizing travel disutility without person.  If you need this without a person, set"
